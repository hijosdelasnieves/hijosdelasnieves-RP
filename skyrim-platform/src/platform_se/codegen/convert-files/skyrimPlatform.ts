...
export declare function setHdnVanillaMenuPolicy(mask: number): void
export declare function getHdnVanillaMenuPolicyState(): HdnVanillaMenuPolicyState
